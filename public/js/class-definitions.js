...
Stapler.prototype.staplePapers = function(numberOfPapers) {
  if (numberOfPapers > this.maxPapers) {
    return false;
  } else {
    return true;
  }
...
var sam = new Animal('Platypus', 'male');
var notWarmOrColdAnimal = sam.isWarmBlooded();
 ...
 *
 */
var skyScraper = new House(100);
var farTooTallAStory = skyScraper.isATallStory(10);
var shortStory = skyScraper.isATallStory(101);
 ...
 *
 */
var awesomeness = new Meal('chips');
var badForYou = awesomeness.containsJunkFood();
